...
public class MyCollections {
     ...
     * After invoking <tt>MyCollections.rotate(list, 1)</tt> (or
     * <tt>MyCollections.rotate(list, -4)</tt>), <tt>list</tt> will comprise
     * <tt>[s, t, a, n, k]</tt>.
     *
     ...
     * <pre>
     *     MyCollections.rotate(list.subList(j, k+1), -1);
     * </pre>
     * To make this concrete, suppose <tt>list</tt> comprises
     * <tt>[a, b, c, d, e]</tt>.  To move the element at index <tt>1</tt>
     * (<tt>b</tt>) forward two positions, perform the following invocation:
     * <pre>
     *     MyCollections.rotate(l.subList(1, 4), -1);
     * </pre>
     ...
     * MyCollections.  Query operations on the returned collection "read through"
    ...
    public static <T> Set<T> synchronizedSet(Set<T> s, Object mutex) {
     ...
     * <pre>
     *  SortedSet s = MyCollections.synchronizedSortedSet(new TreeSet());
     *      ...
     *  synchronized (s) {
     *      Iterator i = s.iterator(); // Must be in the synchronized block
     *      while (i.hasNext())
     ...
     * <pre>
     *  NavigableSet s = MyCollections.synchronizedNavigableSet(new TreeSet());
     *      ...
     *  synchronized (s) {
     *      Iterator i = s.iterator(); // Must be in the synchronized block
     *      while (i.hasNext())
     ...
     * MyCollections views of any of its <tt>subMap</tt>, <tt>headMap</tt> or
     * <tt>tailMap</tt> views.
     * <pre>
     *  SortedMap m = MyCollections.synchronizedSortedMap(new TreeMap());
     *      ...
     *  Set s = m.keySet();  // Needn't be in synchronized block
     *      ...
     *  synchronized (m) {  // Synchronizing on m, not s!
     ...
     * MyCollections views of any of its {@code subMap}, {@code headMap} or
     * {@code tailMap} views.
     * <pre>
     *  NavigableMap m = MyCollections.synchronizedNavigableMap(new TreeMap());
     *      ...
     *  Set s = m.keySet();  // Needn't be in synchronized block
     *      ...
     *  synchronized (m) {  // Synchronizing on m, not s!
     ...
     *  <pre> {@code
     *     Collection<String> c = MyCollections.checkedCollection(
     ...
     * <pre>
     *     Set&lt;String&gt; s = MyCollections.emptySet();
     * </pre>
     ...
     * sorted set:
     * <pre> {@code
     *     SortedSet<String> s = MyCollections.emptySortedSet();
     * }</pre>
     *
     * @implNote Implementations of this method need not create a separate
     ...
     * navigable set:
     * <pre> {@code
     *     NavigableSet<String> s = MyCollections.emptyNavigableSet();
     * }</pre>
     *
     ...
     * <pre>
     *     List&lt;String&gt; s = MyCollections.emptyList();
     * </pre>
     *
     * @implNote
     ...
     * <pre>
     *     Map&lt;String, Date&gt; s = MyCollections.emptyMap();
     * </pre>
     * @implNote Implementations of this method need not create a separate
     ...
     * <p>This example illustrates the type-safe way to obtain an empty map:
     * <pre> {@code
     *     SortedMap<String, Date> s = MyCollections.emptySortedMap();
     * }</pre>
     *
     * @implNote Implementations of this method need not create a separate
     ...
     * <p>This example illustrates the type-safe way to obtain an empty map:
     * <pre> {@code
     *     NavigableMap<String, Date> s = MyCollections.emptyNavigableMap();
     * }</pre>
     *
     * @implNote Implementations of this method need not create a separate
    ...
    private static class SingletonMap<K,V>
        ...
        public Set<Map.Entry<K,V>> entrySet() {
            if (entrySet==null)
                entrySet = MyCollections.<Map.Entry<K,V>>singleton(
     ...
     * simple idiom for sorting (or maintaining) MyCollections (or arrays) of
    ...
    private static class ReverseComparator
        ...
        private Object readResolve() { return MyCollections.reverseOrder(); }
    ...
    /**
     * Returns {@code true} if the two specified MyCollections have no
     * elements in common.
     *
     * <p>Care must be exercised if this method is used on MyCollections that
     ...
     * MyCollections must use the same nonstandard equality test, or the
     * result of this method is undefined.
     *
     * <p>Care must also be exercised when using MyCollections that have
     * restrictions on the elements that they may contain. Collection
     * implementations are allowed to throw exceptions for any operation
     * involving elements they deem ineligible. For absolute safety the
     * specified MyCollections should contain only elements which are
     * eligible elements for both MyCollections.
     *
     ...
     * @return {@code true} if the two specified MyCollections have no
     * elements in common.
    ...
    public static boolean disjoint(Collection<?> c1, Collection<?> c2) {
        ...
        // The collection to be iterated. If the MyCollections' contains() impl
        // are of different O() complexity, the collection with slower
        // contains() will be used for iteration. For MyCollections who's
        ...
        if (c1 instanceof Set) {
            ...
            // Both are mere MyCollections. Iterate over smaller collection.
        ...
        for (Object e : iterate) {
            if (contains.contains(e)) {
                // Found a common element. MyCollections are not disjoint.
                return false;
            }
        }
     ...
     * <pre>
     *     MyCollections.addAll(flavors, "Peaches 'n Plutonium", "Rocky Racoon");
     * </pre>
     *
     ...
     * <pre>
     *    Set&lt;Object&gt; weakHashSet = MyCollections.newSetFromMap(
