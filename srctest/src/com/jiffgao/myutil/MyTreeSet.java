 ...
 * @ClassName: MyTreeSetTest
 * @Description:
 * @date: 2019/12/13
 */
public class MyTreeSet<E> extends AbstractSet<E>
    ...
    /**
     * Returns a shallow copy of this {@code MyTreeSet} instance. (The elements
    ...
    /**
     * Save the state of the {@code MyTreeSet} instance to a stream (that is,
     * serialize it).
     *
    ...
    /**
     * Reconstitute the {@code MyTreeSet} instance from a stream (that is,
     * deserialize it).
     */
